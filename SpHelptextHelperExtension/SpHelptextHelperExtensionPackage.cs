...
using SpHelptextHelperExtension.Commands;
using SpHelptextHelperExtension.Controls;
using System;
using System.Runtime.InteropServices;
using System.Threading;
using Task = System.Threading.Tasks.Task;

namespace SpHelptextHelperExtension
{
    [PackageRegistration(UseManagedResourcesOnly = true, AllowsBackgroundLoading = true)]
    [Guid(SpHelptextHelperExtensionPackage.PackageGuidString)]
    ...
    public sealed class SpHelptextHelperExtensionPackage : AsyncPackage
    {
        /// <summary>
        /// SpHelptextHelperExtensionPackage GUID string.
        /// </summary>
